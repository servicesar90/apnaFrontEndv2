...
const suggestedTitles = ["Manager", "Assistant", "CEO", "COO", "Coordinator"];
    ...
    <div className="flex w-full min-h-screen bg-gray-100 flex-col">
      ...
      {steps === 1 && (
        <div className="w-2/3 p-8 bg-white overflow-y-auto">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <h2 className="text-16 text-gray-800 font-semibold mb-4">
              Experience Details
            </h2>

            {/* Total Years of Experience */}
            <label className="block font-medium text-16 text-gray-800">
              Total Years of Experience
            </label>
            ...
            {(experienceYears !== 0 || experienceMonths !== 0) && (
              <>
                ...
                <TextField
                  ...
                  variant="outlined"
                  fullWidth
                  {...register("experiences[0].companyName", {
                    required: true,
                  })}
                ...
                <Box className="bg-blue-50 text-sm text-gray-700 p-3 rounded-md">
                  <span className="text-blue-800 font-medium">
                    Salary information is important,
                  </span>{" "}
      ...
      {steps === 2 && (
        <form
          ...
          className="p-6 max-w-xl space-y-6"
        >
              ...
              {languages.map((language) => {
                ...
                return (
                  <Chip
                    ...
                    sx={
                      isSelected
                        ? { backgroundColor: "#0784C9", color: "white" }
                        : {}
                    }
                    onClick={() => {
                      if (isSelected) {
