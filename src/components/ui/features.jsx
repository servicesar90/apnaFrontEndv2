  ...
  const features = [
    {
      ...
      description:
        "Experience next-generation job matching with our advanced AI that analyzes your profile, preferences, and market trends to provide personalized career recommendations.",
      color: "from-blue-500 to-cyan-500",
      bgColor: "bg-blue-50",
      benefits: [
    ...
    },
    {
      ...
      description:
        "Create professional, ATS-optimized resumes in minutes with our intelligent resume builder that suggests content based on your experience and target roles.",
      color: "from-purple-500 to-pink-500",
      bgColor: "bg-purple-50",
      benefits: [
    ...
    },
    {
      ...
      title: "Best Recommended for You",
      description:
        "Advanced algorithms analyze your career history, preferences, and market data to suggest the most relevant opportunities tailored specifically for you.",
      color: "from-indigo-500 to-purple-500",
      bgColor: "bg-indigo-50",
      benefits: [
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
                Discover advanced AI-powered tools and intelligent features
                designed to accelerate your job search and connect you with the
                perfect opportunities. Our smart suggestions and resume builder
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button
                  ...
                  className="bg-gradient-to-r from-blue-600 to-indigo-600  hover:from-blue-700 hover:to-indigo-700 font-semibold px-8 py-3 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                >
                  <p className="text-white  z-50">Explore AI Features</p>
                  <ArrowDown className="ml-2 h-5 w-5 text-white z-50" />
                </Button>
              </div>
            </motion.div>
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Join millions of professionals who trust our AI-powered platform
                to connect with top companies worldwide
              </p>
            </motion.div>
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" id="features">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
                Discover our intelligent AI tools and personalized features that
                make job searching effortless and effective. Experience the
                future of career advancement.
              </p>
            </motion.div>
        ...
        >
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            >
              ...
              <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
                Join millions of professionals who have found their dream jobs
                through our intelligent AI-powered platform. Your next
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                {[
                  ...
                  { number: "50K+", label: "Companies" },
                  { number: "1M+", label: "Jobs Posted" },
                  { number: "95%", label: "AI Match Success" },
                ].map((stat, index) => (
                  <motion.div
                    key={stat.label}
                    initial={{ opacity: 0, y: 20 }}
