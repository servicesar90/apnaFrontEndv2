              ...
              return (
                ...
                >
                  ...
                  {item.details.map((line, idx) => (
                    <p key={idx} className="text-sm text-center text-gray-600">
                      {line}
                    </p>
                  ))}
                </motion.div>
          ...
          <Card className="shadow-xl border rounded-xl">
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6 ">
                <div
                  ref={(el) => (formRef.current["form"] = el)}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="transition-all duration-300 focus:scale-100 w-full p-2 border rounded"
                  />
                </div>
                ...
                {faqs.map((faq, index) => (
                  <Accordion key={index}>
                    <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                      <Typography className="text-left font-medium">
                        {faq.question}
                      </Typography>
                    </AccordionSummary>
                    <AccordionDetails>
