...
const EmployeeLandingPage = () => {
  ...
  // AI Features Data
  const aiSuggestionFeatures = [
    {
      icon: Brain,
      title: "Smart Job Recommendations",
      description:
        "Get personalized job suggestions based on your skills, experience, and career aspirations",
      benefits: [
        "95% accuracy rate",
        "Real-time updates",
        "Learning algorithm",
    ...
    },
    {
      ...
      description:
        "Discover trending career paths and skills in your field with AI-driven market analysis",
      benefits: ["Market trends", "Skill predictions", "Salary forecasts"],
    ...
    },
    {
      ...
      description:
        "AI-powered mock interviews and personalized feedback to boost your confidence",
      benefits: [
        "Custom questions",
        "Real-time feedback",
  ...
  const resumeBuilderFeatures = [
    ...
    },
    {
      ...
      description:
        "Smart suggestions for bullet points, skills, and achievements",
      step: "2",
    },
    {
      icon: Eye,
      title: "Real-time Preview",
      description: "See your resume as you build it with instant formatting",
      step: "3",
    },
    {
      icon: Download,
      title: "Multiple Formats",
      description: "Download in PDF, Word, or share with a unique link",
      step: "4",
    },
  ];
  ...
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                ...
                that matches your skills and career goals with the right
                employers. Plus, build professional resumes with our AI resume
                builder.
              </motion.p>
      ...
      <section className="py-24 w-full bg-gradient-to-br from-gray-50 to-blue-50 relative overflow-hidden">
        <div className="container mx-auto px-6">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            className="text-center mb-20"
          >
            <div className="inline-flex items-center space-x-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full px-6 py-3 mb-6">
              <Bot className="w-5 h-5" />
              <span className="font-semibold">Powered by AI</span>
            </div>
            <h2 className="text-4xl lg:text-6xl font-bold text-gray-900 mb-6">
              Smart AI <span className="text-blue-600">Suggestions</span>
            </h2>
            <p className="text-xl lg:text-2xl text-gray-600 max-w-4xl mx-auto">
              Get personalized career recommendations powered by advanced
              machine learning
            </p>
            <p className="text-lg text-gray-600 mt-4 max-w-3xl mx-auto">
              Our AI analyzes millions of job postings, career paths, and market
              trends to provide you with intelligent suggestions that accelerate
              your career growth.
            </p>
          </motion.div>

          <div className="grid lg:grid-cols-3 gap-8 mb-16">
            {aiSuggestionFeatures.map((feature, index) => (
              <motion.div
                key={feature.title}
                initial={{ opacity: 0, y: 50 }}
                whileInView={{ opacity: 1, y: 0 }}
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-gray-600 mb-8 leading-relaxed">
                  Watch how our AI analyzes your profile and provides
                  personalized recommendations in real-time. Our intelligent
                  system learns from your preferences and continuously improves
                  its suggestions.
                </p>
                <div className="space-y-4">
                  {[
                    {
                      icon: Cpu,
                      text: "Real-time job matching based on skills",
                    },
                    {
                      icon: TrendingUp,
                      text: "Market trend analysis and predictions",
                    },
                    {
                      icon: Target,
                    ...
                    {
                      icon: Zap,
                      text: "Instant notifications for relevant opportunities",
                    },
                  ].map((item, idx) => (
                    <div key={idx} className="flex items-center space-x-3">
                ...
                <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-6">
                  <div className="bg-white rounded-xl p-4 shadow-lg mb-4">
                    ...
                    <p className="text-gray-600 text-sm">
                      "Based on your Python and ML experience, I found 47
                      matching roles. Here are the top 3 recommendations..."
                    </p>
                  </div>

                  <div className="space-y-3">
                    {[
                      "Senior ML Engineer - $140K",
                      "Data Scientist - $125K",
                      "AI Researcher - $135K",
                    ].map((job, idx) => (
                      <div
      ...
      <section className="py-24 w-full bg-white relative overflow-hidden">
        <div className="container mx-auto px-6">
          <motion.div
            ...
            className="text-center mb-20"
          >
            <div className="inline-flex items-center space-x-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-full px-6 py-3 mb-6">
            ...
            <p className="text-xl lg:text-2xl text-gray-600 max-w-4xl mx-auto">
              Create ATS-friendly resumes in minutes with intelligent content
              suggestions
            </p>
            <p className="text-lg text-gray-600 mt-4 max-w-3xl mx-auto">
              Our AI resume builder analyzes job descriptions and suggests the
              perfect content, formatting, and keywords to help you stand out
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
            ...
            >
              {resumeBuilderFeatures.map((feature, index) => (
                ...
                >
                  <div className="w-12 h-12 bg-gradient-to-br from-purple-600 to-pink-600 rounded-xl flex items-center justify-center flex-shrink-0 text-white font-bold text-lg group-hover:scale-110 transition-transform duration-300">
                    {feature.step}
                  </div>
                  <div>
            ...
            >
              ...
              <div className="bg-white rounded-2xl shadow-2xl border border-gray-200 p-8 relative overflow-hidden">
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {["Python", "React", "AWS", "Docker", "ML"].map(
                        (skill) => (
                          <span
                            key={skill}
                ...
                {/* AI Writing Assistant Overlay */}
                <motion.div
                  initial={{ opacity: 0, scale: 0.8 }}
                  whileInView={{ opacity: 1, scale: 1 }}
                  viewport={{ once: true }}
                  transition={{ delay: 0.8 }}
                  className="absolute top-4 right-4 bg-gradient-to-br from-purple-600 to-pink-600 rounded-xl p-3 text-white shadow-lg"
                >
              ...
              <motion.div
                ...
                className="absolute -bottom-6 -left-6 bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl p-4 shadow-xl text-white"
              >
                <div className="text-center">
                  <CheckCircle className="w-6 h-6 mx-auto mb-2" />
                  <div className="text-sm font-bold">ATS Optimized</div>
                  <div className="text-xs opacity-80">95% pass rate</div>
                </div>
              </motion.div>
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: 1.2 }}
                className="absolute -top-6 -right-6 bg-gradient-to-br from-blue-500 to-cyan-600 rounded-2xl p-4 shadow-xl text-white"
              >
                <div className="text-center">
                  <Zap className="w-6 h-6 mx-auto mb-2" />
                  <div className="text-sm font-bold">Built in 5 min</div>
          ...
          >
            {[
              ...
              },
              {
                icon: Brain,
                title: "Smart Content",
                description: "AI suggests relevant achievements",
              },
              {
                icon: Eye,
                title: "ATS Friendly",
              ...
              },
              {
                icon: Download,
                title: "Multiple Formats",
                description: "PDF, Word, and shareable links",
              },
            ].map((feature, index) => (
              <motion.div
                key={feature.title}
                ...
                transition={{ delay: index * 0.1 }}
                whileHover={{ scale: 1.05, y: -5 }}
                className="text-center bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-6 border border-purple-100 hover:border-purple-200 transition-all duration-300"
              >
      ...
      <section className="py-24 w-full bg-white relative overflow-hidden">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Real professionals, real success stories. See how Unigrow Talent
              has transformed careers across industries.
            </p>
          </motion.div>
            ...
            <div className="relative h-96 overflow-hidden rounded-3xl">
              <AnimatePresence mode="wait">
                <motion.div
                  ...
                  className="absolute inset-0 bg-gradient-to-br from-blue-50 to-purple-50 p-12 rounded-3xl border border-gray-100"
                >
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <div className="text-center">
                            <div className="text-2xl font-bold text-blue-600">
                              {testimonials[currentIndex].stats.applications}
                            </div>
                          ...
                          <div className="text-center">
                            <div className="text-2xl font-bold text-green-600">
                              {testimonials[currentIndex].stats.timeToHire}
                            </div>
                            <div className="text-sm text-gray-600">
                              Time to Hire
                            </div>
          ...
          <div className="grid lg:grid-cols-5 gap-12 mb-12">
            <div className="lg:col-span-2">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <span className="text-2xl font-bold">Unigrow Talent</span>
              </div>
              <p className="text-gray-400 mb-6 leading-relaxed">
                The world's leading AI-powered career advancement platform,
                connecting exceptional professionals with dream opportunities
                since 2020.
              </p>
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
